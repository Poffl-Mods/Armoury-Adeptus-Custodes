...
{
    internal static class NativeArmouryCacheGenerator
    {
        internal const string BlueprintGuid = "88f437341af34d15ad9d9e24c41dd34d";
        private const string PrefabPath = "Assets/Modifications/AstartesCustodes/Art/CustodesArmouryCache.prefab";
        private const string BlueprintPath = "Assets/Modifications/AstartesCustodes/Blueprints/CustodesArmouryCache_MapObject.jbp";

        internal static void Generate()
        {
            GameObject root = new GameObject("CustodesArmouryCache");
            root.SetActive(false);
            DynamicMapObjectView view = root.AddComponent<DynamicMapObjectView>();
            view.UniqueViewId = "astartes-custodes-warrant-cache";
            ...
            System.Type materialBinderType = System.Type.GetType(
                "AstartesCustodes.Runtime.GuardianSpearMaterialBinder, AstartesCustodes.Runtime");
            if (materialBinderType == null)
                throw new System.InvalidOperationException("Custodes runtime material binder type was not found.");
            ...
            Material black = AssetDatabase.LoadAssetAtPath<Material>("Assets/Modifications/AstartesCustodes/Art/CastellanAxe.mat");
            Material gold = AssetDatabase.LoadAssetAtPath<Material>("Assets/Modifications/AstartesCustodes/Art/PraesidiumShield.mat");
            if (black == null || gold == null) throw new FileNotFoundException("Custodes cache source materials are missing.");
            ...
            JObject bp = new JObject
            {
                ...
                ["Data"] = new JObject
                {
                    ...
                    ["Author"] = "Poffl", ["Comment"] = "Persistent Custodes armoury cache in the Warrant Chamber.",
